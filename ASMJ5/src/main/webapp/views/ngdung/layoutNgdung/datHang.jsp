<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<p class="mt-4 ps-5" style="color: #FF6600;font-size:larger;">
              ...
              <table class="table table-condensed ">
                <tr>
                   ...
                   <b><%-- ${user.getFullname()} ${user.getSdt()} --%></b>
                    <input class="fw-bold" type="text" name="FullName" value="${fullname}" placeholder="Họ và tên...">
                    
                   </td>
                   <td><input class="fw-bold" type="text" name="sdt" value="${sdt}" placeholder="Số điện thoại..."></td>
                   <td></td>
                   <td></td>
                   <td></td>
                   <td><%-- ${user.getDiachi()} --%>
                   <textarea class="fw-bold" name="diachi" rows="2" cols="60" placeholder="Địa chỉ...">${diachi}</textarea>
                   </td> 
                </tr>
              </table>
             
	 <table id="cart" class="table table table-condensed mt-3"> 
	  <thead> 
	   <tr> 
	  ...
	  <tr> 
	   ...
	   <tr> 
	    <td colspan="2"><button class="btn btn-primary">Mua Hàng</button></td> 
	    <td></td>
	    <td colspan="3"><b>Tổng tiền hàng:</b> <span class="text-danger fw-bold">${tongtien} VNĐ</span><br></td> 	   
	   </tr> 
	  </tfoot> 
	 </table>
	 </form>